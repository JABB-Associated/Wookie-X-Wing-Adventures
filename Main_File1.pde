...
SoundFile DuelofFates; //GameMusic
SoundFile IntroMusic; //Intro Music
int frames1 = 0; //used for music
int frames2 = 0;//used for music
...
void setup() { 
  ...
  DuelofFates = new SoundFile(this, "Duel of Fates.mp3");
...
void draw() {
  ...
  //    bosstime = true;
  //    wavetime = false;}
  if (level < 1 && frames1 == 0) { //play intro music
